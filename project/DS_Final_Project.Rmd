...
### An exploratory data analysis and comparison of the top 10 albums from 2016-2020 to my personal favorite albums

## Introduction
Music is one of the greatest forms of self-expression. You can learn a lot about a person based on their favorite artists and/or albums. 
...
Here, I am selecting the factors I want to examine.
...
What is a good danceability of a popular album? What about energy? Loudness? To find our rating classification, I will take the quartiles (Q1, Q2(mean), Q3) for each factor and compare them to my own by year. 
